				...
				mapActions:function() {
					...
					if ((ontile>=0) && (ontile<100)) { 
						maingame.setTileInMap(xc,yc,ontile+100,true);
                                        ...
                                        if (ontile==203) { maingame.gotoLevel({level:"endgame",x:90,y:90,introdialogue:true,label:"...?"}); }
					...
					if ((ontile==202) && (!tilemaps.queststatus["math002complete"])) {
						...
						if (tilemaps.queststatus["_tmpmath001fail"]==true) {
							...
							tilemaps.queststatus["math002complete"] = true;
						}
					}
				},
